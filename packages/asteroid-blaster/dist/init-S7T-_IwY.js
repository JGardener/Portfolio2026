import { M as P, i as y, T as _, j as b, b as O, c as M, U as A, k as U, l as v, m as E, R as z, w as Y, o as R } from "./index-DSUTNz5_.js";
import { c as V } from "./canvasUtils-D48cVmQS.js";
import { C as X } from "./CanvasPool-D9DQb38I.js";
import { F as q } from "./Filter-CV_4ltTq.js";
const S = new P();
function C(d, e) {
  e.clear();
  const t = e.matrix;
...
class G {
  ...
  generateFilteredTexture({ texture: e, filters: t }) {
    ...
    if (r.length === 0 && i === 1)
      return e;
    const s = V.getCanvasSource(e);
    if (!s)
      return e;
    const n = e.frame, a = e.source._resolution ?? e.source.resolution ?? 1, o = n.width, l = n.height, f = X.getOptimalCanvasAndContext(o, l, a), { canvas: c, context: u } = f;
  ...
  _calculateFilterArea(e, t) {
    if (e.renderables ? C(e.renderables, t) : e.filterEffect.filterArea ? (t.clear(), t.addRect(e.filterEffect.filterArea), t.applyMatrix(e.container.worldTransform)) : e.container.getFastGlobalBounds(!0, t), e.container) {
...
class B {
  ...
  _setupBindGroupsAndRender(e, t, r) {
    ...
    }), r.type === z.WEBGL && r.renderTarget.finishRenderPass();
  }
  /**
  ...
  _calculateFilterBounds(e, t, r, i, s) {
    ...
    for (let T = 0; T < o.length; T++) {
      ...
      if (g.blendRequired && !(((h = n.backBuffer) == null ? void 0 : h.useBackBuffer) ?? !0)) {
        Y("Blend filter requires backBuffer on WebGL renderer to be enabled. Set `useBackBuffer: true` in the renderer options."), p = !1;
        break;
      }
